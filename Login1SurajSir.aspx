	...
	<body bottomMargin="0" leftMargin="0" topMargin="0"    rightMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table borderColor="gray" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="1">
				...
				<tr><td><img src="Images\Login.jpg" height="533"  width=750 ></td> 
					<td width="250" valign="middle">
						<table cellSpacing="0"  align="right" cellPadding="0" width="30%" border="0" >
							...
							<tr>
								<td colSpan="3">
									<table borderColor="gray" cellSpacing="0" bgcolor="#ffffff"   cellPadding="2" rules="none" width="100%" align="center"
										background="" border="1" frame="border">
										<tr>
