				...
				<tr>
					<td colSpan="9">
						<table borderColor="black" cellSpacing="0" cellPadding="0" rules="none" width="100%" border="1"
							frame="box">
							<tr>
								<td width="100%"><asp:label id="LblMsg" runat="server" Width="100%" ForeColor="Red" Font-Size="11px"></asp:label></td>
							</tr>
							<tr>
								<td width="100%">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td width="30%"><asp:textbox id="txtEM_CD" runat="server" Width="100%" ForeColor="#003366" AutoPostBack="True"
													Font-Bold="True" CssClass="TextBox" BackColor="#E1E4EB" ReadOnly="True"></asp:textbox></td>
											<td align="center" width="50%"><asp:label id="LblName" runat="server" Width="100%" ForeColor="#003366" Font-Size="9" Font-Bold="True"></asp:label></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								<td vAlign="top" width="100%"><asp:datagrid id="GrdFamily" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True"
										AllowSorting="True">
