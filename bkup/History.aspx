								...
								<td width="50%">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td width="60%"><asp:textbox id="txtEM_CD" runat="server" Width="100%" ReadOnly="True" CssClass="TextBox" ForeColor="#003366"
											...
											<td><asp:datagrid id="GrdQual" runat="server" Width="100%" AllowSorting="True" AllowPaging="True"
													...
													<Columns>
														...
														<asp:TemplateColumn HeaderText="Year">
															...
															<ItemTemplate>
																<asp:TextBox id=txtYr runat="server" ForeColor="#003366" Width="100%" MaxLength="4" CssClass="TextBox" Text='<%# DataBinder.Eval(Container.DataItem, "Passing_Year") %>'>
																</asp:TextBox>
															</ItemTemplate>
														</asp:TemplateColumn>
