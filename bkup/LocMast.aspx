<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LocMast.aspx.vb" Inherits="eHRMS.Net.LocMast"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table borderColor="gray" cellSpacing="0" cellPadding="0" rules="none" width="600" align="center"
				...
				<tr>
					<td style="HEIGHT: 37px">State</td>
					<td style="HEIGHT: 37px"><asp:dropdownlist id="cmbState" runat="server" Width="280px" AutoPostBack="True"></asp:dropdownlist></td>
				</tr>
				<tr>
