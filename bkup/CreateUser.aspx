...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table borderColor="gray" cellSpacing="1" cellPadding="1" rules="none" width="600" align="center"
				...
				<tr>
					<td colSpan="3">
						<table id="TBLGeneral" cellSpacing="0" cellPadding="0" width="100%">
							...
							<tr>
								<td>&nbsp;User ID</td>
								<td colSpan="2"><asp:textbox id="TxtUserID" CssClass="textbox" Runat="server" Width="100" ForeColor="#003366"></asp:textbox><asp:dropdownlist id="cmbUserID" runat="server" Width="200px" AutoPostBack="True" Visible="False"></asp:dropdownlist>&nbsp;
									<asp:imagebutton id="btnList" Runat="server" Width="18px" Height="19px" ImageUrl="Images\Find.gif"
										ImageAlign="AbsMiddle"></asp:imagebutton><asp:imagebutton id="btnNew" Runat="server" Width="18px" ImageUrl="Images\NewFile.ico" ImageAlign="AbsMiddle"></asp:imagebutton></td>
							</tr>
							<tr>
								<td>&nbsp;User Name</td>
								<td colSpan="2"><asp:textbox id="TxtUserName" CssClass="textbox" Runat="server" Width="90%"></asp:textbox></td>
							</tr>
							<tr>
								<td>&nbsp;Group Name</td>
								<td colSpan="2"><asp:dropdownlist id="CmbGroupName" Runat="server" Width="90%"></asp:dropdownlist></td>
							</tr>
							<tr>
								<td>&nbsp;Password</td>
								<td colSpan="2"><asp:textbox id="TxtPass" CssClass="textbox" Runat="server" Width="90%" TextMode="Password" ForeColor="#003366"></asp:textbox></td>
							</tr>
							<tr>
								<td>&nbsp;Confirm Password</td>
								<td><asp:textbox id="TxtConPass" CssClass="textbox" Runat="server" Width="223px" TextMode="Password"
				...
				<tr>
					<td align="right" colSpan="3"><asp:button id="CmdSave" runat="server" Text="Save" width="75px"></asp:button>&nbsp;&nbsp;<asp:button id="CmdClose" runat="server" Text="Close" width="75px"></asp:button></td>
				</tr>
			</table>
		</form>
	</body>
