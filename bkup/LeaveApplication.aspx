	...
	<body MS_POSITIONING="GridLayout" topmargin="0" rightmargin="0" leftmargin="0" bottommargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<table cellSpacing="0" cellPadding="0" rules="none" width="750" align="center" border="1"
				...
				<tr>
					<td class="Header3"><b>Leave Type*</b></td>
				...
				<tr>
					<td class="Header3">Leave For*</td>
					<td class="Header3" colSpan="3"><asp:dropdownlist id="cmbLvFor" runat="server" Width="250px"></asp:dropdownlist></td>
				</tr>
				<tr>
					<td colSpan="4">&nbsp;</td>
				</tr>
				<tr>
					...
					<td class="Header3" style="HEIGHT: 19px"><asp:button id="cmdCalDays" runat="server" Width="100px" Text="Calculate Days"></asp:button>
						&nbsp;&nbsp;Days*&nbsp;<asp:textbox id="txtDays" runat="server" Width="50px" CssClass="TextBox" ReadOnly="True" ForeColor="#003366"></asp:textbox>
					</td>
				</tr>
				<tr>
					<td colSpan="4">&nbsp;</td>
				...
				<tr>
					<td class="Header3">Manager*</td>
					<td colspan="3" class="Header3"><asp:dropdownlist id="cmbManager" runat="server" Width="250px"></asp:dropdownlist></td>
				</tr>
				<tr>
					<td colSpan="4">&nbsp;</td>
				</tr>
				<tr>
					<td class="Header3">Address &amp; Contact No.*</td>
				...
				<tr>
					<td colspan="4" class="Header3" align="right">* Mandatory Fields</td>
				</tr>
				<TR>
					<TD colspan="4">
