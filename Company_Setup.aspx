...
<HTML>
	<HEAD>
		...
		<script language="vbscript">
			Sub ShowSubTab(argID)
					document.getElementById("TrGeneral").style.backgroundColor="cecbce"
					document.getElementById("TrSignatory").style.backgroundColor="cecbce"
					document.getElementById("TrReimbursement").style.backgroundColor="cecbce"
					
					document.getElementById("TrGeneral").style.color="003366"
					document.getElementById("TrSignatory").style.color="003366"
					document.getElementById("TrReimbursement").style.color="003366"
	...
	<body MS_POSITIONING="GridLayout" onload="ShowSubTab('TrGeneral')">
		<form id="Form1" method="post" runat="server">
			...
			<table borderColor="gray" cellSpacing="0" cellPadding="0" rules="none" width="600" align="center"
				...
				<tr>
					<td>
						<table id="TrGeneral" cellSpacing="0" cellPadding="0" width="100%" border="0" bgColor="#666666"
							runat="server">
							<tr>
								<td width="10"><IMG alt="" src="Images/SplitLeft.gif" border="0">
								</td>
								<td style="CURSOR: hand" onclick="ShowSubTab('TrGeneral')" align="center"><b>General</b>
								</td>
								<td width="10"><IMG alt="" src="Images/rightcurve.gif" border="0">
								</td>
							</tr>
						</table>
					</td>
					<td>
						<table id="TrSignatory" cellSpacing="0" cellPadding="0" width="100%" border="0" bgColor="#cecbce"
							runat="server">
							<tr>
								<td width="10"><IMG alt="" src="Images/SplitLeft.gif" border="0"></td>
								<td style="CURSOR: hand" onclick="ShowSubTab('TrSignatory')" align="center"><b>Signatory</b></td>
								<td width="10"><IMG alt="" src="Images/rightcurve.gif" border="0">
								</td>
							</tr>
						</table>
					...
					<td>
						<table id="TrReimbursement" cellSpacing="0" cellPadding="0" width="100%" border="0" bgColor="#cecbce"
							runat="server">
							<tr>
								<td width="10"><IMG alt="" src="Images/SplitLeft.gif" border="0"></td>
								<td style="CURSOR: hand" onclick="ShowSubTab('TrReimbursement')" align="center"><b>Reimbursement</b>
								</td>
				...
				<tr>
					<td colSpan="3">
						<table id="TblGeneral" cellSpacing="1" cellPadding="0" width="100%" border="0">
							<tr>
								<td width="15%"></td>
								<td width="35%"></td>
								<td width="15%"></td>
				...
				<tr>
					<td colSpan="3">
						<table id="TblSignatory" style="DISPLAY: none" cellSpacing="0" cellPadding="0" rules="none"
				...
				<tr>
					<td colSpan="3">
						<table id="TblReimbursement" style="DISPLAY: none" cellSpacing="0" cellPadding="0" rules="none"
							width="100%" border="1" frame="border" runat="server">
							<tr>
