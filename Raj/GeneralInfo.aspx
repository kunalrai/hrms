				...
				function CallBack(response)
				{
					...
					{				
						...
						if (aRow.length > 1)
						{
						 ...
						 {
						 document.getElementById("dtpDOBcmbDD").DateValue= '000';
						 document.getElementById("dtpDOBcmbMM").DateValue= '19000000';
						 document.getElementById("dtpDOBcmbYY").DateValue= '000000';	
						 }
						 ...
						 {
						  document.getElementById("dtpPassportExpcmbDD").DateValue= dt.Tables[0].Rows[0]['DOV'].getDate();
						 document.getElementById("dtpPassportExpcmbMM").DateValue= dt.Tables[0].Rows[0]['DOV'].getMonth()+1;	
						 document.getElementById("dtpPassportExpcmbYY").DateValue= dt.Tables[0].Rows[0]['DOV'].getYear();
						}
			...
			function ValidateCtrl()
				...
				If document.getElementById("txtMPIN").Value <> "" Then
					If Len(document.getElementById("txtMPIN").Value) <> 6 Then
						msgbox ("Mailing Pin Non Must be of Six Digit.")
						ValidateCtrl = False
						Exit Function
					End If
				End If
							...
							<tr id="trOtherInfo" runat="server">
								...
								<td vAlign="top" width="50%">
									<table cellSpacing="0" cellPadding="2" width="100%" border="0">
										...
										<TR>
											<TD>
												<asp:label id="lblPassport" runat="server" Width="147px" ToolTip="Passport No.">Passport No</asp:label></TD>
											<TD>
												<asp:textbox id="txtPassportNo" runat="server" Width="75px" CssClass="TextBox" MaxLength="20"></asp:textbox>
												<cc1:dtpcombo id="dtpPassportExp" runat="server" Width="100PX" Height="20px" ToolTip="Date of Birth"
