...
<HTML>
	<HEAD>
		...
		<script language="vbscript">
			Sub OpenWin()
				...
				windownopen document.getElementById("ReportType").value,"","status=yes,toolbar=yes,menubar=yes,scrollbars=yes,resizable=yes"
			End Sub
	...
	<body runat="server" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE borderColor="#98a9ca" cellSpacing="1" cellPadding="1" rules="none" width="600" align="center"
				border="1" frame="box">
				<tr>
					<td vAlign="top" width="75%" rowSpan="4"><asp:listbox id="LstReports" runat="server" AutoPostBack="True" Height="300px" Width="402px"
							Rows="7" ForeColor="#003366"></asp:listbox></td>
					<td vAlign="top" width="25%">
						...
						<TABLE id="TblDate" borderColor="#98a9ca" cellSpacing="0" cellPadding="0" rules="none"
							...
							<TR>
								<TD align="center"><cc1:dtpcombo id="dtpAsOn" runat="server" Height="20px" Width="100%" ToolTip="As on Date"></cc1:dtpcombo></TD>
							</TR>
						</TABLE>
						<TABLE id="TblDateRange" borderColor="#98a9ca" cellSpacing="0" cellPadding="0" rules="none"
							...
							<TR>
								<TD>From</TD>
								<TD><cc1:dtpcombo id="dtpFrom" runat="server" Height="20px" Width="100%" ToolTip="Start Date"></cc1:dtpcombo></TD>
							</TR>
							<TR>
								<TD>To</TD>
								<TD><cc1:dtpcombo id="dtpTo" runat="server" Height="20px" Width="100%" ToolTip="End Date"></cc1:dtpcombo></TD>
							</TR>
						</TABLE>
					</td>
				</tr>
				<tr>
					<td vAlign="top" width="180">
						<TABLE id="TBLFOR" borderColor="#98a9ca" cellSpacing="0" cellPadding="0" rules="none" width="95%"
							align="center" border="1" frame="border" runat="server">
							<tr>
								<td class="Header3" align="center" background="Images\headstripe.jpg" colSpan="2"><b>For</b></td>
							</tr>
							<tr>
								<td style="HEIGHT: 22px"><asp:dropdownlist id="cmbFor" runat="server" AutoPostBack="True" Width="180"></asp:dropdownlist></td>
							</tr>
							<tr>
								<td><asp:dropdownlist id="cmbForVal" runat="server" Width="150px"></asp:dropdownlist><asp:textbox id="TxtFroVal" Width="150" Runat="server" Visible="False"></asp:textbox><asp:button id="CmdFor" runat="server" Height="22px" Width="24px" ToolTip="Click to Find Details"
										Font-Bold="True" ForeColor="DimGray" Font-Size="12pt" Font-Names="Wingdings" Text="&amp;"></asp:button></td>
							</tr>
						</TABLE>
					</td>
				</tr>
				<tr>
					<td vAlign="top" width="180">
						<TABLE id="TblOrderBy" cellSpacing="0" cellPadding="0" width="95%" align="center" border="0"
							runat="server">
							<tr>
								<td class="Header3" align="center" background="Images\headstripe.jpg" colSpan="2"><b>Order 
										by</b></td>
							</tr>
							<tr>
								<td><asp:dropdownlist id="cmbOrdBy" runat="server" Width="180px"></asp:dropdownlist></td>
							</tr>
						</TABLE>
					</td>
				</tr>
				<tr>
					<td width="180">
						<TABLE id="TblLType" cellSpacing="0" cellPadding="0" width="95%" align="center" border="0"
							...
							<tr>
								<td><asp:dropdownlist id="cmbLTYPE" runat="server" Width="180px">
				...
				<tr>
					<td vAlign="top" align="left"><asp:label id="LblMsg" runat="server" Width="100%" ForeColor="Red" Font-Size="11px"></asp:label></td>
			...
			<asp:button id="cmdRefresh" style="Z-INDEX: 104; LEFT: 864px; POSITION: absolute; TOP: 32px"
				...
				runat="server" Height="0px" Width="0px" ReadOnly="True">frmHTMLReports.aspx</asp:textbox><asp:textbox id="TxtProp" style="Z-INDEX: 103; LEFT: 16px; POSITION: absolute; TOP: 8px" runat="server"
