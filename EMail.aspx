...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" onload="ShowBtn()">
		<form id="Form1" method="post" runat="server">
			<!--#include file=MenuBars.aspx -->
			<asp:textbox id="TxtRights" style="Z-INDEX: 103; LEFT: 200px; POSITION: absolute; TOP: 472px"
				runat="server" Width="0px"></asp:textbox><br>
			<br>
			...
			<table cellSpacing="0" cellPadding="0" rules="none" width="500" align="center" border="1"
				...
				<tr>
					<td align="right" colSpan="2"><INPUT id="BtnSend" style="WIDTH: 78px; HEIGHT: 24px" type="button" onclick="SendMail()"
							value="Send">&nbsp;&nbsp;&nbsp;
			...
			<asp:textbox id="txtServer" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 464px" runat="server"
				Width="192px" Visible="False"></asp:textbox><asp:button id="cmdSend" style="Z-INDEX: 102; LEFT: 952px; POSITION: absolute; TOP: 32px" runat="server"
