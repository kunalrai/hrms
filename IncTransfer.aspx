...
<HTML>
	<HEAD>
		...
		<script language="vbscript">
			sub ShowHide(args)
					Dim num
					num = args
					document.getElementById("txtTabNum").value = num
	...
	<body onload="ShowHide(document.getElementById('txtTabNum').value)" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table cellSpacing="0" cellPadding="0" rules="none" width="750" border="1" frame="border">
				<tr>
					...
					<td colSpan="2">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td width="10">Code</td>
								<td width="100" colSpan="3"><asp:textbox id="TxtCode" ForeColor="#003366" Width="80" Runat="server" AutoPostBack="True" CssClass="textbox"></asp:textbox><asp:dropdownlist id="cmbEmp" runat="server" Width="150" AutoPostBack="True" Visible="False"></asp:dropdownlist><asp:imagebutton id="btnList" Width="18px" Runat="server" Height="19px" ImageUrl="Images\Find.gif"
										ImageAlign="AbsMiddle" CausesValidation="False"></asp:imagebutton></td>
								<td width="200" colSpan="2"><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ErrorMessage="Please Select the code"
										Display="Dynamic" ControlToValidate="TxtCode"></asp:requiredfieldvalidator><asp:label id="LblName" runat="server" Font-Size="9" ForeColor="#003366" Width="100%" Font-Bold="True"></asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
									...
									<td><asp:datagrid id="GrdEarnings" runat="server" Width="100%" AllowPaging="False" AutoGenerateColumns="False">
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Present">
													...
													<ItemTemplate>
														<asp:TextBox id=txtAmount_Ern onblur=CheckNum(this.id) AutoPostBack=True style="TEXT-ALIGN: right" runat="server" Width="100%" CssClass="TextBox" Text='<%# DataBinder.Eval(Container.DataItem, "Amount") %>' MaxLength='<%# DataBinder.Eval(Container.DataItem, "Field_Len") %>'>
														</asp:TextBox>
												...
												<asp:TemplateColumn>
													...
													<ItemTemplate>
														<asp:TextBox id=txtField_Name_Ern runat="server" AutoPostBack=True Width="0Px" CssClass="TextBox" Text='<%# DataBinder.Eval(Container.DataItem, "FIELD_NAME") %>'>
														</asp:TextBox>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn>
													...
													<ItemStyle HorizontalAlign="Center" Width="0px"></ItemStyle>
													<ItemTemplate>
														<asp:TextBox Width="0Px" runat="server" ID="txtDataType_Ern" onblur=CheckNum(this.id) AutoPostBack=True CssClass="TextBox" Text='<%# DataBinder.Eval(Container.DataItem, "Field_Type") %>' />
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn HeaderText="Proposed">
													<ItemStyle HorizontalAlign="Right" Width="15%"></ItemStyle>
													<ItemTemplate>
														<asp:TextBox Width="100%" onblur=CheckNum(this.id) runat="server" AutoPostBack=True style ="TEXT-ALIGN: right" ID="TxtPdAmount" CssClass="TextBox" Text='<%# DataBinder.Eval(Container.DataItem, "Amount") %>' MaxLength='<%# DataBinder.Eval(Container.DataItem, "Field_Len") %>' />
				...
				<tr>
					<td align="left">Month&nbsp;&nbsp;<asp:dropdownlist id="CmbMonth" Width="100px" Runat="server"></asp:dropdownlist></td>
					<td align="right"><asp:button id="cmdSave" runat="server" Width="75px" Text="Save"></asp:button>&nbsp;&nbsp;<asp:button id="CmdDelete" runat="server" Width="75px" Text="Delete"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:textbox id="txtTabNum" runat="server" Width="0px" Height="0px" ReadOnly="True">TBJobAllocation</asp:textbox><asp:button id="cmdClose" accessKey="C" runat="server" Width="75px" Text="Close" CausesValidation="False"></asp:button></td>
				</tr>
			</table>
		</form>
	</body>
