...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" runat="server">
		<form id="Form1" method="post" runat="server">
			<!--#include file=MenuBars.aspx --><asp:button id="cmdSetValues" style="Z-INDEX: 105; LEFT: 8px; POSITION: absolute; TOP: 8px"
				runat="server" BorderColor="White" Text="Button" Width="0px"></asp:button><br>
			<br>
			...
			<TABLE borderColor="#98a9ca" cellSpacing="0" cellPadding="0" rules="none" width="600" align="center"
				border="1" frame="box">
				<tr>
					<td width="100%" colSpan="5"><asp:label id="LblMsg" runat="server" Width="100%" Font-Size="11px" ForeColor="Red"></asp:label></td>
				</tr>
				<tr>
					<td vAlign="top" width="55%" rowSpan="4"><asp:listbox id="LstReports" runat="server" Width="100%" ForeColor="#003366" Rows="7" Height="300px"
					...
					<td vAlign="top" width="45%">
						...
						<TABLE id="TblMonthRange" borderColor="#98a9ca" cellSpacing="0" cellPadding="0" rules="none"
							...
							<TR>
								...
								<TD style="HEIGHT: 24px"><asp:dropdownlist id="cmbMonthFrom" runat="server" Width="100px">
								...
								<TD style="HEIGHT: 24px"><asp:dropdownlist id="cmbYearFrom" runat="server" Width="55px">
						...
						<TABLE id="TblDateRange" borderColor="#98a9ca" cellSpacing="0" cellPadding="0" rules="none"
							...
							<TR>
								...
								<TD style="HEIGHT: 18px"><cc1:dtpcombo id="dtpFrom" runat="server" Width="100%" Height="20px" ToolTip="Start Date"></cc1:dtpcombo></TD>
							</TR>
							<TR>
								<TD>To</TD>
				...
				<tr>
					<td vAlign="top" width="225">
						<TABLE id="TBLFOR" style="WIDTH: 268px; HEIGHT: 81px" borderColor="#98a9ca" cellSpacing="0"
							cellPadding="0" rules="none" width="268" align="center" border="1" frame="border" runat="server">
							<tr>
								<td class="Header3" style="HEIGHT: 12px" align="center" background="Images\headstripe.jpg"
									colSpan="2"><b>For</b></td>
							</tr>
							<tr>
								<td style="HEIGHT: 6px"><asp:dropdownlist id="cmbFor" runat="server" Width="262px" AutoPostBack="True"></asp:dropdownlist></td>
							</tr>
							<tr>
								<td><asp:dropdownlist id="cmbForVal" runat="server" Width="242px" AutoPostBack="True"></asp:dropdownlist><asp:textbox id="TxtFroVal" Width="237px" ForeColor="#003366" Visible="False" Runat="server"
										CssClass="TextBox"></asp:textbox><asp:button id="CmdFor" runat="server" Text="&amp;" Width="24px" Font-Size="12pt" ForeColor="DimGray"
										ToolTip="Click to Find Details" Font-Names="Wingdings" Font-Bold="True"></asp:button></td>
							</tr>
						</TABLE>
					</td>
				</tr>
				<tr>
					<td vAlign="top" width="180">
						<TABLE id="TblOrderBy" style="WIDTH: 269px; HEIGHT: 32px" cellSpacing="0" cellPadding="0"
							width="269" align="center" border="0" runat="server">
							<tr>
								<td class="Header3" style="WIDTH: 271px" align="center" background="Images\headstripe.jpg"
									colSpan="2"><b>Order by</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td style="HEIGHT: 3px" vAlign="top" align="left"><asp:label id="LblPages" style="Z-INDEX: 105" runat="server" Font-Size="X-Small" ForeColor="Blue">Format</asp:label>&nbsp;&nbsp;
					...
					<td style="HEIGHT: 3px" vAlign="top" align="left"><asp:radiobutton id="OptHtml" runat="server" Text="HTML" GroupName="optReportType"></asp:radiobutton><asp:radiobutton id="optCrystal" runat="server" Text="Crystal" GroupName="optReportType" Checked="True"></asp:radiobutton></td>
				</tr>
				<tr>
					<td vAlign="top" align="right" colSpan="2">
						<hr width="100%" color="#98a9ca">
						<asp:button id="cmdPrint" accessKey="P" runat="server" Text="Print" Width="75px" Visible="False"></asp:button>&nbsp;
						<asp:button id="cmdExport" accessKey="E" runat="server" Text="Export" Width="75px" Visible="False"></asp:button>&nbsp;
						<asp:button id="cmdMail" accessKey="M" runat="server" Text="E-Mail" Width="75px" Visible="False"></asp:button>&nbsp;
			...
			<asp:button id="cmdRefresh" style="Z-INDEX: 104; LEFT: 864px; POSITION: absolute; TOP: 32px"
				runat="server" Text="Button" Width="0px"></asp:button><asp:textbox id="ReportType" style="Z-INDEX: 102; LEFT: 154px; POSITION: absolute; TOP: 37px"
