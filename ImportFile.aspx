	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table borderColor="gray" cellSpacing="0" cellPadding="0" rules="none" width="600" align="center"
				...
				<tr>
					<td colspan="2" width="100%"><asp:label id="LblErrMsg" runat="server" ForeColor="Red"></asp:label></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="HEIGHT: 20px"><asp:dropdownlist id="CmbImport" runat="server" Width="352px" AutoPostBack="True"></asp:dropdownlist></td>
				</tr>
				<tr>
					<td>File Name</td>
				...
				<tr>
					<td style="HEIGHT: 36px">Period <FONT color="#ff3366">(dd-mmm-yyyy)</FONT></td>
					<td style="HEIGHT: 36px">From :
						<asp:TextBox id="TxtFrom" runat="server" Enabled="False"></asp:TextBox>&nbsp;To 
						:
						<asp:TextBox id="TxtTo" runat="server" Enabled="False"></asp:TextBox></td>
				</tr>
				<tr>
					...
					<td colSpan="2">
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server">
							<tr>
								...
								<td align="right" width="15%"><asp:button id="cmdSave" runat="server" Text="Save" Width="75px" Visible="False"></asp:button></td>
