	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="2" rules="none" width="500" align="center" border="1"
				...
				<tr>
					<td style="HEIGHT: 14px" align="left" width="25%"><asp:label id="Label4" Runat="server" text="Month" Font-Size="10pt">Format</asp:label></td>
					<td style="HEIGHT: 14px" align="left" width="75%" colSpan="3"><asp:dropdownlist id="cmbFormat" runat="server" Width="100%" AutoPostBack="True"></asp:dropdownlist></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" width="25%"><asp:button id="cmdImport" runat="server" Width="54px" Text="Import"></asp:button><INPUT style="WIDTH: 47px; HEIGHT: 24px" onclick="showdata();" type="button" value="Show"></td>
			...
			<HR>
			<DIV align="center"><asp:datagrid id="grdImport" style="Z-INDEX: 101" runat="server" AutoGenerateColumns="True">
