				...
				<tr>
					<td>
						<table id="TblFields" cellSpacing="0" cellPadding="0" width="100%" runat="server">
							...
							<tr>
								<td class="Header3" colSpan="2" style="HEIGHT: 12px">Step : Select fields to 
									include in report.</td>
							</tr>
							<tr>
								<td colSpan="2">&nbsp;</td>
							</tr>
								...
								<td>
									...
									<div style="WIDTH: 695px; BORDER-TOP-STYLE: outset; HEIGHT: 75px">
										<table cellSpacing="0" cellPadding="0" width="100%">
											...
											<tr>
												<td class="Header3" style="HEIGHT: 18px"><asp:textbox id="TxtOpnB" Width="100%" ForeColor="#003366" Runat="server"></asp:textbox></td>
												<td class="Header3" style="HEIGHT: 18px"><asp:dropdownlist id="cmbFields" Width="100%" Runat="server"></asp:dropdownlist></td>
												<td class="Header3" align="left" style="HEIGHT: 18px"><asp:dropdownlist id="cmbCompare" Width="100%" Runat="server">
												...
												<td class="Header3" style="HEIGHT: 18px"><asp:textbox id="TxtCondition" Width="100%" Runat="server"></asp:textbox></SELECT></td>
												<td class="Header3" style="HEIGHT: 18px"><asp:textbox id="TxtCloB" Width="100%" ForeColor="#003366" Runat="server"></asp:textbox></td>
												<td class="Header3" style="HEIGHT: 18px"><asp:dropdownlist id="cmbAndOr" Width="100%" Runat="server">
